...
1. Add the remaining ingredients in, continuing to whisk for another 30-60 seconds, then remove from heat and taste for salt, adding only if required.
1. Serve hot over escalope.
